# facility-upgrade-atlas-v0.1 Slice Guide

Export: `exports/facility-upgrade-atlas-v0.1.png`
Source: `sources/facility-upgrade-atlas-v0.1-source.png`
Grid: 6 columns x 3 rows
Image size: 1536 x 1024 px
Approx cell: 256.0 x 341.33 px
...
## Content Notes
Six facility families with three upgrade tiers: desk, R&D board, sales booth, server rack, meeting table, rest/coffee.
