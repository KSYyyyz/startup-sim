...
Startup Sim 是一款以 AI 创业公司经营为主题的俯视角办公室建造与管理模拟游戏。

一句话目标：

> 玩家作为 AI SaaS 创始人，在俯视角办公室中划分部门区域、摆放和升级设施、招聘并管理员工，用可见的空间经营动作推动产品、增长、融资、客户和竞品博弈，走出不同创业命运。
...
- 使用自由 CEO 指令表达高层意图，但它是辅助入口，不是主玩法。
