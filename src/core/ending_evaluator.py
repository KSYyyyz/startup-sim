...
- series_a_success: month >= 12 AND mrr >= 500,000 AND product >= 70 AND equity >= 50
- survived_but_average: month >= 12 AND mrr >= 200,000 AND cash > 0
